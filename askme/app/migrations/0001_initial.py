    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.ImageField(blank=True, default='static/media/image/avatar/200.jpeg', upload_to='static/madia/image/avatar/', verbose_name='Аватарка')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_create', models.DateTimeField(auto_now_add=True, verbose_name='Дата создания')),
                ('content', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='like', to='app.owner')),
