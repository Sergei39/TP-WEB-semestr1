    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('text', models.TextField(verbose_name='Текст')),
                ('data_create', models.DateField(auto_now_add=True, verbose_name='Дата создания')),
                ('tag', models.ManyToManyField(related_name='question', to='app.Tag')),
                ('user', models.ForeignKey(blank=True, default='', on_delete=django.db.models.deletion.SET_DEFAULT, to='app.user')),
            ],
            options={
                'verbose_name': 'Вопрос',
